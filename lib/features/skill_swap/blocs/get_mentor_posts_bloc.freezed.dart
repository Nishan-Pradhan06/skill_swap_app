...
part of 'get_mentor_posts_bloc.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetMentorPostsEvent);
}
...
/// @nodoc
class $GetMentorPostsEventCopyWith<$Res>  {
$GetMentorPostsEventCopyWith(GetMentorPostsEvent _, $Res Function(GetMentorPostsEvent) __);
}


/// Adds pattern-matching-related methods to [GetMentorPostsEvent].
extension GetMentorPostsEventPatterns on GetMentorPostsEvent {
...
class _GetPosts implements GetMentorPostsEvent {
  const _GetPosts();
...
@override
String toString() {
  return 'GetMentorPostsEvent.getPosts()';
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GetMentorPostsState);
}
...
/// @nodoc
class $GetMentorPostsStateCopyWith<$Res>  {
$GetMentorPostsStateCopyWith(GetMentorPostsState _, $Res Function(GetMentorPostsState) __);
}


/// Adds pattern-matching-related methods to [GetMentorPostsState].
extension GetMentorPostsStatePatterns on GetMentorPostsState {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
class _Initial implements GetMentorPostsState {
  const _Initial();
...
@override
String toString() {
  return 'GetMentorPostsState.initial()';
}
...
class _Loading implements GetMentorPostsState {
  const _Loading();
...
@override
String toString() {
  return 'GetMentorPostsState.loading()';
}
...
class _Loaded implements GetMentorPostsState {
...
/// Create a copy of GetMentorPostsState
...
@override
String toString() {
  return 'GetMentorPostsState.loaded(posts: $posts)';
}
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $GetMentorPostsStateCopyWith<$Res> {
...
class _Failure implements GetMentorPostsState {
...
@override
String toString() {
  return 'GetMentorPostsState.failure(message: $message)';
}
...
/// @nodoc
abstract mixin class _$FailureCopyWith<$Res> implements $GetMentorPostsStateCopyWith<$Res> {
